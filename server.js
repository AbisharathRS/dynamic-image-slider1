...
const path = require('path');     // NEW: for sending app.html

// Use env variable in real projects
const JWT_SECRET = process.env.JWT_SECRET || 'secret_key_for_demo';
...
// Serve frontend (app.html and related files) from this folder
...
// --- Connect to MongoDB ---
mongoose.connect(
  process.env.MONGODB_URI || 'mongodb+srv://abiabi9486842923_db_user:abi@cluster0.k4uyqp3.mongodb.net/?appName=Cluster0'
...
app.listen(PORT, () => console.log(`IBM Store backend running on http://localhost:${PORT}`));
